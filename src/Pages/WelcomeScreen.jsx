...
const TypewriterEffect = ({ text }) => {
  ...
  useEffect(() => {
    ...
    }, 200); // Reducido de 260ms a 200ms para que termine más rápido
...
const WelcomeScreen = ({ onLoadingComplete }) => {
  ...
  useEffect(() => {
    ...
    const typingDuration = (20 * 200) + 2000; // 20 caracteres * 200ms + 2 segundos de espera después de terminar
    const totalDuration = typingDuration + 1000; // Tiempo total antes de desvanecer la pantalla

    const timer = setTimeout(() => {
      setIsLoading(false);
      setTimeout(() => {
        onLoadingComplete?.();
      }, 1000); // Mantenemos 1 segundo para la animación de salida
    }, typingDuration); // Ajustado para esperar a que termine el efecto de escritura + 2 segundos
        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <a
                  href="https://jose-ortega-dev.netlify.app/"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="Visita: www.jose.ortega.dev" />
                    </span>
                  </div>
                </a>
              </motion.div>
