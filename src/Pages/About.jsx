...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    // Calcular el número de proyectos
    const projectCount = projectsData.length;

    // Calcular el número de certificados
    const certificationCount = certificatesData.length;
    ...
    return {
      ...
      totalCertificates: certificationCount,
  ...
  const statsData = useMemo(() => [
    {
      ...
      value: totalProjects,
      label: "Proyectos",
      description: "Soluciones web innovadoras creadas",
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1yXMCL45dP9vXiwDoH-gd7dN02EfWi8qg/view">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
