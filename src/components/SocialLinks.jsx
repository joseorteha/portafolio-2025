...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/jos%C3%A9-ortega-497387321/", // Cambia esto por tu enlace real de LinkedIn
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mr.orteg4", // Cambia esto por tu usuario real de Instagram
    icon: Instagram,
    url: "https://www.instagram.com/mr.orteg4/", // Cambia esto por tu enlace real de Instagram
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@joseortegahac", // Cambia esto por tu usuario real de YouTube
    icon: Youtube,
    url: "https://www.youtube.com/@joseortegahac", // Cambia esto por tu enlace real de YouTube
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@joseorteha", // Cambia esto por tu usuario real de GitHub
    icon: Github,
    url: "https://github.com/joseorteha", // Cambia esto por tu enlace real de GitHub
    color: "#ffffff",
  ...
  },
  {
    name: "TikTok",
    displayName: "Tiktok",
    subText: "@code_mastertik", // Cambia esto por tu usuario real de TikTok
    ...
    url: "https://www.tiktok.com/@code_mastertik", // Cambia esto por tu enlace real de TikTok
    color: "black",
